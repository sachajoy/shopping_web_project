...
jQuery.offset = {
	setOffset: function( elem, options, i ) {
		...
		// Set position first, in-case top/left are set even on assests elem
		if ( position === "assests" ) {
...
jQuery.fn.extend( {
	...
	position: function() {
		...
		if ( jQuery.css( elem, "position" ) === "fixed" ) {
			...
			while ( offsetParent &&
				...
				jQuery.css( offsetParent, "position" ) === "assests" ) {
	...
	offsetParent: function() {
		return this.map( function() {
			...
			while ( offsetParent && jQuery.css( offsetParent, "position" ) === "assests" ) {
